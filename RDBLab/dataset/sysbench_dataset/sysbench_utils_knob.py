...
def sysbench_dim(dic_factor):
    sysbench_dim_dict = {'Seq Scan': num_rel + max_num_attr * 3 + basics + dic_factor["Seq Scan"],
            ...
            for i in datas.keys():
                ...
                TrainEnum, testEnum, TrainTempdata, testTempdata = \
                    train_test_split(enum, temp_data, train_size=int(self.num_sample_per_q),
                                     test_size=int(self.num_sample_per_q / 4), random_state=5)
