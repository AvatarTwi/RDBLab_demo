from RDBLab.dataset.oltp_dataset.attr_rel_dict import rel_names, index_names, join_types, parent_rel_types, \
    aggreg_strats

max_num_attr = 20  # 3*20 min_vec + med_vec + max_vec
# 'c_custkey','c_name','c_address','c_nationkey','c_phone','c_acctbal','c_mktsegment','c_comment'import RDBLab.config
...
dim_dict = {'Seq Scan': [3, 10, 60, 0, [0, 0, 0, 0, 0, 0], 2, 0],
                 ...
                 'ModifyTable':  [3, 10, 0, 0, 0, [0, 0, 0, 0, 0, 0], 2, 32],
