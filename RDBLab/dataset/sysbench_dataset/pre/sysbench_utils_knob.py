...
from RDBLab.dataset.sysbench_dataset.cost_factor.cost_factor import cost_factor_main
...
def sysbench_dim(dic_factor):
    sysbench_dim_dict = {'Seq Scan': knob_num + num_rel + max_num_attr * 3 + basics + len(dic_factor["Seq Scan"]),
