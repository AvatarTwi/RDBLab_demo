...
from RDBLab.dataset.sysbench_dataset.sysbench_utils_origin import SysbenchDataset as SysbenchDataset_origin, \
    sysbench_dim_dict as origin_sysbench_dim
from RDBLab.dataset.sysbench_dataset.sysbench_utils_knob import SysbenchDataset as SysbenchDataset_knob, \
    sysbench_dim as knob_sysbench_dim
