...
from RDBLab.dataset.oltp_dataset.attr_rel_dict import aggreg_strats
...
def tpcc_dim(dic_factor):
    tpcc_dim_dict = {'Seq Scan': knob_num + basics + len(dic_factor["Seq Scan"]),
...
def tpcc_dim_array(dic_factor):
    tpcc_dim_array_dict = {'Seq Scan': [basics,0, 0, len(dic_factor["Seq Scan"]), knob_num, 0],
