...
import numpy as np
import torch
from RDBLab.collections import Counter, defaultdict
from RDBLab.dataset.postgres_tpch_dataset.tpch_utils import PSQLTPCHDataSet
...
class OLTPDataSet(PSQLTPCHDataSet):
    def __init__(self, opt):
        ...
        if opt.mode!='test':
            ...
            with open(opt.data_structure + '/mean_range_dict.pkl', 'wb') as f:
