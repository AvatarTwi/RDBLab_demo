from RDBLab.dataset.postgres_tpch_dataset.attr_rel_dict import rel_names, index_names, join_types, parent_rel_types, \
    aggreg_strats

max_num_attr = 16  # min_vec + med_vec + max_vec
